...
import JPA_Ejemplo_2.servicios.DireccionServicio;
import JPA_Ejemplo_2.servicios.MascotaServicio;
import JPA_Ejemplo_2.servicios.PersonaServicio;
...
public class Menu {
    ...
    public void ejecucion() {
        ...
        try {
            String inputDate = "07/28/2011 11:06:37";
            nacimiento = new SimpleDateFormat("MM/dd/yyyy hh:mm:ss").parse(inputDate);
